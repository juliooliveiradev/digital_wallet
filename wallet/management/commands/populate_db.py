...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        if wallet_created:
            self.stdout.write(self.style.SUCCESS(f"Carteira para o usuário '{username}' criada com sucesso!"))
        else:
            self.stdout.write(self.style.WARNING(f"Carteira para o usuário '{username}' já existe!"))
